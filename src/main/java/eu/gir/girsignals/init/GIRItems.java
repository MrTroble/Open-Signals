...
public class GIRItems {
	...
	public static final Placementtool SIGN_PLACEMENT_TOOL = new Placementtool(GIRBlocks.LF_SIGNAL, GIRBlocks.EL_SIGNAL, GIRBlocks.SH_SIGNAL, GIRBlocks.RA_SIGNAL, GIRBlocks.BUE_SIGNAL, GIRBlocks.OTHER_SIGNAL);
