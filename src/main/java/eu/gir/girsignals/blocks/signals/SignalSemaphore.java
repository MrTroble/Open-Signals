...
public class SignalSemaphore extends Signal {
    ...
    public SignalSemaphore() {
        super(builder(GIRItems.PLACEMENT_TOOL, "semaphore_signal").height(3).offsetX(10f).offsetY(-11f).signHeight(1.47f).build());
    }
    ...
    public static final SEProperty<Boolean> WING1 = SEProperty.of("wing1", false,
            ChangeableStage.APISTAGE_NONE_CONFIG, false, check(SEMATYPE, Boolean.TRUE));
    public static final SEProperty<Boolean> WING2 = SEProperty.of("wing2", false,
            ChangeableStage.APISTAGE_NONE_CONFIG, false, check(SEMATYPE, Boolean.TRUE).and(check(HP2, Boolean.TRUE)));
    ...
    public static final SEProperty<Boolean> VR_PLATE = SEProperty.of("vr_plate", false,
            ChangeableStage.APISTAGE_NONE_CONFIG, false, check(SEMATYPE, Boolean.FALSE));
    public static final SEProperty<SemaDist> VR_WING = SEProperty.of("vr_wing", SemaDist.VR0,
            ChangeableStage.APISTAGE_NONE_CONFIG, false, check(SEMATYPE, Boolean.FALSE));
