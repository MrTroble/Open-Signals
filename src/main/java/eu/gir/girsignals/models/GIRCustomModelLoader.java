...
public class GIRCustomModelLoader implements ICustomModelLoader {
	...
	public void onResourceManagerReload(final IResourceManager resourceManager) {
		...
		final Map<String, ModelStats> modelmap = ModelStats.getfromJson("/assets/girsignals/modeldefinitions");
		...
		for (Map.Entry<String, ModelStats> modelstatemap : modelmap.entrySet()) {
			...
			if (!filename.equalsIgnoreCase("zs32.json") || !filename.equalsIgnoreCase("mastsigns.json")) {
					...
					for (Map.Entry<String, Models> entry2 : content.getModels().entrySet()) {
						...
						modelstats.getTexture().forEach(texturestate -> {
							...
							final Predicate<IExtendedBlockState> state = GIRBlockstateParser
									.getPredicateFromString(texturestate.getBlockstate(), filename, modelname);

							if (texturestate.isautoBlockstate()) {
								cm.register(modelname, ebs -> true, modelstats.getX(), modelstats.getY(),
										modelstats.getZ(), ModelStats.createRetexture(texturestate.getRetextures(),
												content.getTextures()));

							} else if (state != null && !texturestate.isautoBlockstate()) {
								cm.register(modelname, state, modelstats.getX(), modelstats.getY(), modelstats.getZ(),
										ModelStats.createRetexture(texturestate.getRetextures(),
												content.getTextures()));

							} else if (state == null && !texturestate.isautoBlockstate()) {
								GirsignalsMain.log.warn("The predicate of " + modelname + " in " + filename
							...
							cm.register("hv/hv_exit",
									with(SignalHV.STOPSIGNAL, hpvr -> hpvr.equals(HP.HP2))
											.and(with(SignalHV.HPTYPE, hpt -> hpt.equals(HPType.STOPSIGNAL))
													.or(hasNot(SignalHV.HPTYPE))),
									5.4f, "lamp_greennorth", "girsignals:blocks/lamps/lamp_green", "lamp_yellownorth",
									"girsignals:blocks/lamps/lamp_yellow");
							// HP off
							cm.register("hv/hv_exit",
							...
							cm.register("hv/hv_vr", with(SignalHV.DISTANTSIGNAL, hpvr -> hpvr.equals(VR.VR0)), 4,
									"lamp_yellow_1north", "girsignals:blocks/lamps/lamp_yellow", "lamp_yellow_2north",
									"girsignals:blocks/lamps/lamp_yellow");
							// VR1
		...
		registeredModels.put("kssignal", cm -> {
			...
			cm.register("ks/ks_signal",
					with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.OFF)).and(
							with(SignalKS.KSTYPE, kst -> kst.equals(KSType.STOPSIGNAL)).or(hasNot(SignalKS.KSTYPE))),
					5);
			// HP 0
			cm.register("ks/ks_signal",
					with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.HP0)).and(
							with(SignalKS.KSTYPE, kst -> kst.equals(KSType.STOPSIGNAL)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_rednorth", "girsignals:blocks/lamps/lamp_red");
			// KS 1
			cm.register("ks/ks_signal",
					with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS1)).and(
							with(SignalKS.KSTYPE, kst -> kst.equals(KSType.STOPSIGNAL)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_greennorth", "girsignals:blocks/lamps/lamp_green");
			// KS 1 Blink
			cm.register("ks/ks_signal",
					with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS1_BLINK)).and(
							with(SignalKS.KSTYPE, kst -> kst.equals(KSType.STOPSIGNAL)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_greennorth", "girsignals:blocks/lamps/lamp_green_blink");
			// KS 1 Blink Light
			cm.register("ks/ks_signal",
					with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS1_BLINK_LIGHT)).and(
							with(SignalKS.KSTYPE, kst -> kst.equals(KSType.STOPSIGNAL)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_greennorth", "girsignals:blocks/lamps/lamp_green_blink", "lamp_white_identifiernorth",
					"girsignals:blocks/lamps/lamp_white");
			// KS 2
			cm.register("ks/ks_signal",
					with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS2)).and(
							with(SignalKS.KSTYPE, kst -> kst.equals(KSType.STOPSIGNAL)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_yellownorth", "girsignals:blocks/lamps/lamp_yellow");
			// KS 2 Light
			cm.register("ks/ks_signal",
					with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS2_LIGHT)).and(
							with(SignalKS.KSTYPE, kst -> kst.equals(KSType.STOPSIGNAL)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_yellownorth", "girsignals:blocks/lamps/lamp_yellow", "lamp_white_identifiernorth",
					"girsignals:blocks/lamps/lamp_white");
			// KS Zs1
			cm.register("ks/ks_signal",
					with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS_ZS1)).and(
							with(SignalKS.KSTYPE, kst -> kst.equals(KSType.STOPSIGNAL)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_rednorth", "girsignals:blocks/lamps/lamp_red", "lamp_white_sh_zsnorth",
					"girsignals:blocks/lamps/lamp_white_blink");
			// KS Zs7
			cm.register("ks/ks_signal",
					with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS_ZS7)).and(
							with(SignalKS.KSTYPE, kst -> kst.equals(KSType.STOPSIGNAL)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_rednorth", "girsignals:blocks/lamps/lamp_red", "lamp_white_zs7north",
					"girsignals:blocks/lamps/lamp_yellow");
			// KS RS
			cm.register("ks/ks_signal",
					with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS_SHUNTING)).and(
							with(SignalKS.KSTYPE, kst -> kst.equals(KSType.STOPSIGNAL)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_rednorth", "girsignals:blocks/lamps/lamp_red", "lamp_white_sh_zsnorth",
					"girsignals:blocks/lamps/lamp_white", "lamp_white_shnorth", "girsignals:blocks/lamps/lamp_white");
			// KS Status light
			cm.register("ks/ks_signal",
					with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS_STATUS_LIGHT)).and(
							with(SignalKS.KSTYPE, kst -> kst.equals(KSType.STOPSIGNAL)).or(hasNot(SignalKS.KSTYPE))),
			...
			// KS off Distant
			cm.register("ks/ks_signal_dist", with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KSDistant.OFF))
					.and(with(SignalKS.KSTYPE, kst -> kst.equals(KSType.DISTANT))), 5);
			// KS 1 Distant
			cm.register("ks/ks_signal_dist",
					with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KSDistant.KS1))
							.and(with(SignalKS.KSTYPE, kst -> kst.equals(KSType.DISTANT)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_greennorth", "girsignals:blocks/lamps/lamp_green");
			// KS 1 Repeat Distant
			cm.register("ks/ks_signal_dist",
					with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KSDistant.KS1_REPEAT))
							.and(with(SignalKS.KSTYPE, kst -> kst.equals(KSType.DISTANT)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_greennorth", "girsignals:blocks/lamps/lamp_green", "lamp_white_sh_zsnorth",
					"girsignals:blocks/lamps/lamp_white");
			// KS 1 Blink Distant
			cm.register("ks/ks_signal_dist",
			...
			cm.register("ks/ks_signal_dist",
					with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KSDistant.KS2_REPEAT))
							.and(with(SignalKS.KSTYPE, kst -> kst.equals(KSType.DISTANT)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_yellownorth", "girsignals:blocks/lamps/lamp_yellow", "lamp_white_sh_zsnorth",
					"girsignals:blocks/lamps/lamp_white");
		...
		registeredModels.put("hlsignal", cm -> {
			...
			// HL Lightbar off
			cm.register("hl/hl_shield2", with(SignalHL.LIGHTBAR, hllb -> hllb.equals(HLLightbar.OFF)), 4);
			// HL Lightbar green
			cm.register("hl/hl_shield2", with(SignalHL.LIGHTBAR, hllb -> hllb.equals(HLLightbar.GREEN)), 4,
					"lamp_greennorth", "girsignals:blocks/lamps/lamp_green");
			// HL Lightbar yellow
			cm.register("hl/hl_shield2", with(SignalHL.LIGHTBAR, hllb -> hllb.equals(HLLightbar.YELLOW)), 4,
					"lamp_yellownorth", "girsignals:blocks/lamps/lamp_yellow");
			// HL off
			cm.register("hl/hl_shield1", with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.OFF))
					.and(with(SignalHL.HLTYPE, hlt -> hlt.equals(HLType.MAIN)).or(hasNot(SignalHL.HLTYPE))), 5);
			// HL red
			cm.register("hl/hl_shield1",
					with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.HP0))
							.and(with(SignalHL.HLTYPE, hlt -> hlt.equals(HLType.MAIN)).or(hasNot(SignalHL.HLTYPE))),
					5, "lamp_rednorth", "girsignals:blocks/lamps/lamp_red");
			// HL alternate red
			cm.register("hl/hl_shield1",
			...
			cm.register("hl/hl_shield1",
					with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.HL5_6))
							.and(with(SignalHL.HLTYPE, hlt -> hlt.equals(HLType.MAIN)).or(hasNot(SignalHL.HLTYPE))),
					5, "lamp_greennorth", "girsignals:blocks/lamps/lamp_green_blink", "lamp_yellow2north",
					"girsignals:blocks/lamps/lamp_yellow");
			// HL 7
			cm.register("hl/hl_shield1",
			...
			cm.register("hl/hl_shield1",
					with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.HL8_9))
							.and(with(SignalHL.HLTYPE, hlt -> hlt.equals(HLType.MAIN)).or(hasNot(SignalHL.HLTYPE))),
					5, "lamp_yellownorth", "girsignals:blocks/lamps/lamp_yellow_blink", "lamp_yellow2north",
					"girsignals:blocks/lamps/lamp_yellow");
			// HL 10
			cm.register("hl/hl_shield1",
			...
			cm.register("hl/hl_shield1",
					with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.HL11_12))
							.and(with(SignalHL.HLTYPE, hlt -> hlt.equals(HLType.MAIN)).or(hasNot(SignalHL.HLTYPE))),
					5, "lamp_yellownorth", "girsignals:blocks/lamps/lamp_yellow", "lamp_yellow2north",
					"girsignals:blocks/lamps/lamp_yellow");
			// HL Zs1
			cm.register("hl/hl_shield1",
			...
			// HL Exit Off
			cm.register("hl/hl_main", with(SignalHL.EXITSIGNAL, hl -> hl.equals(HLExit.OFF))
					.and(with(SignalHL.HLTYPE, hlt -> hlt.equals(HLType.EXIT))).or(hasNot(SignalHL.HLTYPE)), 5);

			// HL Exit red
			cm.register("hl/hl_main",
					with(SignalHL.EXITSIGNAL, hl -> hl.equals(HLExit.HP0))
							.and(with(SignalHL.HLTYPE, hlt -> hlt.equals(HLType.EXIT)).or(hasNot(SignalHL.HLTYPE))),
					5, "lamp_rednorth", "girsignals:blocks/lamps/lamp_red");
			...
			cm.register("hl/hl_sh1",
					hasAndIs(SignalHL.SHUNTINGLIGHT).and(has(SignalHL.EXITSIGNAL))
							.and(with(SignalHL.EXITSIGNAL, hl -> hl.equals(HLExit.HL_SHUNTING)).negate().and(
									with(SignalHL.HLTYPE, hlt -> hlt.equals(HLType.EXIT)).or(hasNot(SignalHL.HLTYPE)))),
					5);
			...
			cm.register("hl/hl_main",
					with(SignalHL.EXITSIGNAL, hl -> hl.equals(HLExit.HL_SHUNTING)).and(hasAndIs(SignalHL.SHUNTINGLIGHT))
							.and(with(SignalHL.HLTYPE, hlt -> hlt.equals(HLType.EXIT)).or(hasNot(SignalHL.HLTYPE)).and(
									with(SignalHL.HLTYPE, hlt -> hlt.equals(HLType.EXIT)).or(hasNot(SignalHL.HLTYPE)))),
					5, "lamp_rednorth", "girsignals:blocks/lamps/lamp_red", "lamp_white_sh_2north",
					"girsignals:blocks/lamps/lamp_white");
			...
			// HL off Distant
			cm.register("hl/hl_shield_dist", with(SignalHL.DISTANTSIGNAL, hl -> hl.equals(HLDistant.OFF))
					.and(with(SignalHL.HLTYPE, hlt -> hlt.equals(HLType.DISTANT)).or(hasNot(SignalHL.HLTYPE))), 5);
			// HL 1 Distant
			cm.register("hl/hl_shield_dist",
					with(SignalHL.DISTANTSIGNAL, hl -> hl.equals(HLDistant.HL1))
							.and(with(SignalHL.HLTYPE, hlt -> hlt.equals(HLType.DISTANT)).or(hasNot(SignalHL.HLTYPE))),
					5, "lamp_greennorth", "girsignals:blocks/lamps/lamp_green");
			// HL 4 Distant
			cm.register("hl/hl_shield_dist",
		...
		registeredModels.put("shlight", cm -> {
			...
			cm.register("sh/sh_light",
					with(SignalSHLight.SHLIGHT_0, sh -> sh.equals(SHLight.OFF)).and(hasAndIsNot(SignalSHLight.SH_HIGH)),
					0);
			// SH ground sh0
			cm.register("sh/sh_light",
					with(SignalSHLight.SHLIGHT_0, sh -> sh.equals(SHLight.SH0)).and(hasAndIsNot(SignalSHLight.SH_HIGH)),
					0, "lamp_rednorth", "girsignals:blocks/lamps/lamp_red");
			// SH ground sh1
			cm.register("sh/sh_light",
					with(SignalSHLight.SHLIGHT_0, sh -> sh.equals(SHLight.SH1)).and(hasAndIsNot(SignalSHLight.SH_HIGH)),
			...
			// SH above off
			cm.register("sh/sh_light",
					with(SignalSHLight.SHLIGHT_0, sh -> sh.equals(SHLight.OFF)).and(hasAndIs(SignalSHLight.SH_HIGH)),
					2);
			// SH above sh0
			cm.register("sh/sh_light",
					with(SignalSHLight.SHLIGHT_0, sh -> sh.equals(SHLight.SH0)).and(hasAndIs(SignalSHLight.SH_HIGH)), 2,
					"lamp_rednorth", "girsignals:blocks/lamps/lamp_red");
			// SH above sh1
			cm.register("sh/sh_light",
					with(SignalSHLight.SHLIGHT_0, sh -> sh.equals(SHLight.SH1)).and(hasAndIs(SignalSHLight.SH_HIGH)), 2,
					"lamp_whitenorth", "girsignals:blocks/lamps/lamp_white", "lamp_white2north",
					"girsignals:blocks/lamps/lamp_white");
		...
		registeredModels.put("tramsignal", cm -> {
			...
			cm.register("trafficlight/trafficlight_tram", with(SignalTram.TRAMSIGNAL, Tram.OFF::equals)
					.and(with(SignalTram.TRAMSIGNAL_TYPE, TramType.TRAM::equals)), 0);
			// TRAM f0
			...
			cm.register("trafficlight/trafficlight_tram_single",
					with(SignalTram.TRAMSIGNAL_ADD, TramAdd.A::equals).and(hasAndIsNot(SignalTram.TRAMSIGNAL_A))
							.and(with(SignalTram.TRAMSIGNAL_TYPE, tram -> tram.equals(TramType.TRAM))),
					1);
			cm.register("trafficlight/trafficlight_tram_single",
					with(SignalTram.TRAMSIGNAL_ADD, TramAdd.A::equals).and(hasAndIs(SignalTram.TRAMSIGNAL_A))
							.and(with(SignalTram.TRAMSIGNAL_TYPE, tram -> tram.equals(TramType.TRAM))),
					1, "rednorth", "girsignals:blocks/tram/a");
			cm.register("trafficlight/trafficlight_tram_single",
					with(SignalTram.TRAMSIGNAL_ADD, TramAdd.T::equals).and(hasAndIsNot(SignalTram.TRAMSIGNAL_T))
							.and(with(SignalTram.TRAMSIGNAL_TYPE, tram -> tram.equals(TramType.TRAM))),
					1);
			cm.register("trafficlight/trafficlight_tram_single",
					with(SignalTram.TRAMSIGNAL_ADD, TramAdd.T::equals).and(hasAndIs(SignalTram.TRAMSIGNAL_T))
							.and(with(SignalTram.TRAMSIGNAL_TYPE, tram -> tram.equals(TramType.TRAM))),
					1, "rednorth", "girsignals:blocks/tram/t");
			cm.register("trafficlight/trafficlight_tram_single",
					with(SignalTram.TRAMSIGNAL_ADD, TramAdd.AT::equals).and(hasAndIsNot(SignalTram.TRAMSIGNAL_T))
							.and(with(SignalTram.TRAMSIGNAL_TYPE, tram -> tram.equals(TramType.TRAM))),
					1);
			cm.register("trafficlight/trafficlight_tram_single",
					with(SignalTram.TRAMSIGNAL_ADD, TramAdd.AT::equals).and(hasAndIs(SignalTram.TRAMSIGNAL_T))
							.and(with(SignalTram.TRAMSIGNAL_TYPE, tram -> tram.equals(TramType.TRAM))),
					1, "rednorth", "girsignals:blocks/tram/t");
			cm.register("trafficlight/trafficlight_tram_single",
					with(SignalTram.TRAMSIGNAL_ADD, TramAdd.AT::equals).and(hasAndIsNot(SignalTram.TRAMSIGNAL_A))
							.and(with(SignalTram.TRAMSIGNAL_TYPE, tram -> tram.equals(TramType.TRAM))),
					1.375f);
			cm.register("trafficlight/trafficlight_tram_single",
					with(SignalTram.TRAMSIGNAL_ADD, TramAdd.AT::equals).and(hasAndIs(SignalTram.TRAMSIGNAL_A))
							.and(with(SignalTram.TRAMSIGNAL_TYPE, tram -> tram.equals(TramType.TRAM))),
			...
			cm.register("trafficlight/trafficlight_tram", with(SignalTram.TRAM_SWITCH, TramSwitch.OFF::equals)
					.and(with(SignalTram.TRAMSIGNAL_TYPE, TramType.SWITCH::equals)), 0);
			cm.register("trafficlight/trafficlight_tram",
		...
		registeredModels.put("lfsignal", cm -> {
			cm.register("mast_lamps", with(SignalLF.LFTYPE, lamps -> lamps.equals(LFBachground.LF1)), 0);
			cm.register("mast", ebs -> true, 0);
			for (final LF lf1 : LF.values()) {
				final String[] rename = lf1.getOverlayRename();
				cm.register("lf/lf1",
						with(SignalLF.LFTYPE, LFBachground.LF1::equals).and(with(SignalLF.INDICATOR, lf1::equals)), 1,
						rename);
				cm.register("lf/lf1_2",
						with(SignalLF.LFTYPE, LFBachground.LF2::equals).and(with(SignalLF.INDICATOR, lf1::equals)), 1,
						rename);
				cm.register("lf/lf3_5",
						with(SignalLF.LFTYPE, LFBachground.LF3_5::equals).and(with(SignalLF.INDICATOR, lf1::equals)), 1,
						rename);
				cm.register("lf/lf4",
						with(SignalLF.LFTYPE, LFBachground.LF4::equals).and(with(SignalLF.INDICATOR, lf1::equals)), 1,
						rename);
				cm.register("lf/lf6",
						with(SignalLF.LFTYPE, LFBachground.LF6::equals).and(with(SignalLF.INDICATOR, lf1::equals)), 1,
						rename);
				cm.register("lf/lf7",
						with(SignalLF.LFTYPE, LFBachground.LF7::equals).and(with(SignalLF.INDICATOR, lf1::equals)), 1,
						rename);
			}
		});
		registeredModels.put("elsignal", cm -> {
			...
			cm.register("el/el_arrow_lr", with(SignalEL.ELARROW, ela -> ela.equals(ELArrow.LEFT_RIGHT)), 2);
			cm.register("el/el_arrow_l", with(SignalEL.ELARROW, ela -> ela.equals(ELArrow.LEFT)), 2);
			cm.register("el/el_arrow_r", with(SignalEL.ELARROW, ela -> ela.equals(ELArrow.RIGHT)), 2);
		...
		registeredModels.put("rasignal", cm -> {
			...
			cm.register("ra/ra11_sh1",
					hasAndIsNot(SignalRA.RALIGHT).and(with(SignalRA.RATYPE, ra -> ra.equals(RA.RA11A))
		...
		registeredModels.put("othersignal", cm -> {
			cm.register("mast", with(SignalOther.OTHERTYPE, other -> other.equals(OtherSignal.CROSS)).negate(), 0);
			cm.register("other_signals/hm_sign", with(SignalOther.OTHERTYPE, OtherSignal.HM::equals), 1);
			cm.register("other_signals/ob_sign", with(SignalOther.OTHERTYPE, OtherSignal.OB::equals), 1);
			cm.register("other_signals/cross_sign", with(SignalOther.OTHERTYPE, OtherSignal.CROSS::equals), 0);
		});
		registeredModels.put("nesignal", cm -> {
			...
			cm.register("ne/ne2_2", with(SignalNE.NEADDITION, nea -> nea.equals(NEAddition.PRE1))
					.and(with(SignalNE.NETYPE, ne -> ne.equals(NE.NE2) || ne.equals(NE.NE2_1))), 1);
			cm.register("ne/ne2_3", with(SignalNE.NEADDITION, nea -> nea.equals(NEAddition.PRE2))
					.and(with(SignalNE.NETYPE, ne -> ne.equals(NE.NE2) || ne.equals(NE.NE2_1))), 1);
			...
			for (final Map.Entry<NE, Float> entry : entrys) {
				for (final Arrow arrow : Arrow.values()) {
					if (arrow == Arrow.OFF)
						continue;
					cm.register("arrow",
							with(SignalNE.ARROWPROP, arrow::equals).and(with(SignalNE.NETYPE, entry.getKey()::equals)),
		...
		registeredModels.put("stationnumberplate", cm -> {
			for (final STNumber num : STNumber.values()) {
				...
				cm.register("other_signals/station_number", (with(StationNumberPlate.STATIONNUMBER, num::equals)), 0,
						rename);
			}
		});
		registeredModels.put("wnsignal", cm -> {
			cm.register("wn/wn1_2",
					hasAndIsNot(SignalWN.WNTYPE).and(with(SignalWN.WNNORMAL, wn -> wn.equals(WNNormal.OFF))), 0);
			cm.register("wn/wn1_2",
					hasAndIsNot(SignalWN.WNTYPE).and(with(SignalWN.WNNORMAL, wn -> wn.equals(WNNormal.WN1))), 0,
					"lamp_1", "girsignals:blocks/lamps/lamp_white", "lamp_3", "girsignals:blocks/lamps/lamp_white");
			cm.register("wn/wn1_2",
					hasAndIsNot(SignalWN.WNTYPE).and(with(SignalWN.WNNORMAL, wn -> wn.equals(WNNormal.WN2))), 0,
					"lamp_2", "girsignals:blocks/lamps/lamp_white", "lamp_3", "girsignals:blocks/lamps/lamp_white");
			cm.register("wn/wn1_2",
					hasAndIsNot(SignalWN.WNTYPE).and(with(SignalWN.WNNORMAL, wn -> wn.equals(WNNormal.BLINK))), 0,
					"lamp_3", "girsignals:blocks/lamps/lamp_white_blink");
			cm.register("wn/wn3_6", hasAndIs(SignalWN.WNTYPE).and(with(SignalWN.WNCROSS, wn -> wn.equals(WNCross.OFF))),
					0);
			cm.register("wn/wn3_6", hasAndIs(SignalWN.WNTYPE).and(with(SignalWN.WNCROSS, wn -> wn.equals(WNCross.WN3))),
					0, "lamp_1", "girsignals:blocks/lamps/lamp_white", "lamp_3", "girsignals:blocks/lamps/lamp_white",
					"lamp_5", "girsignals:blocks/lamps/lamp_white");
			cm.register("wn/wn3_6", hasAndIs(SignalWN.WNTYPE).and(with(SignalWN.WNCROSS, wn -> wn.equals(WNCross.WN4))),
					0, "lamp_1", "girsignals:blocks/lamps/lamp_white", "lamp_2", "girsignals:blocks/lamps/lamp_white",
					"lamp_4", "girsignals:blocks/lamps/lamp_white");
			cm.register("wn/wn3_6", hasAndIs(SignalWN.WNTYPE).and(with(SignalWN.WNCROSS, wn -> wn.equals(WNCross.WN5))),
					0, "lamp_1", "girsignals:blocks/lamps/lamp_white", "lamp_3", "girsignals:blocks/lamps/lamp_white",
					"lamp_4", "girsignals:blocks/lamps/lamp_white");
			cm.register("wn/wn3_6", hasAndIs(SignalWN.WNTYPE).and(with(SignalWN.WNCROSS, wn -> wn.equals(WNCross.WN6))),
					0, "lamp_1", "girsignals:blocks/lamps/lamp_white", "lamp_2", "girsignals:blocks/lamps/lamp_white",
					"lamp_5", "girsignals:blocks/lamps/lamp_white");
			cm.register("wn/wn3_6",
					hasAndIs(SignalWN.WNTYPE).and(with(SignalWN.WNCROSS, wn -> wn.equals(WNCross.BLINK))), 0, "lamp_1",
					"girsignals:blocks/lamps/lamp_white_blink");
		});
