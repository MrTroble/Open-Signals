...
public class GIRCustomModelLoader implements ICustomModelLoader {
	...
	public void onResourceManagerReload(IResourceManager resourceManager) {
		...
		registeredModels.put("hvsignal", cm -> {
			...
			for (MAST_SIGN sign : MAST_SIGN.values())
				if(!sign.equals(MAST_SIGN.OFF))
					cm.register("hv/hv_sign", with(SignalHV.MASTSIGN, ms -> ms.equals(sign)), 1, "2", "girsignals:blocks/" + sign.getName());
			...
			// Zs1 on
			cm.register("hv/hv_zs1", hasAndIs(SignalHV.ZS1).and(has(SignalHV.STOPSIGNAL)), 4.4f, "lamp1north", "girsignals:blocks/lamp_white_small");
			// Zs1 off
			cm.register("hv/hv_zs1", hasAndIsNot(SignalHV.ZS1).and(has(SignalHV.STOPSIGNAL)), 4.4f);
			// Zs7 on
			cm.register("hv/hv_zs7", hasAndIs(SignalHV.ZS7).and(has(SignalHV.STOPSIGNAL)), 4.6f, "lamp1north", "girsignals:blocks/lamp_yellow_small");
			// Zs7 off
			cm.register("hv/hv_zs7", hasAndIsNot(SignalHV.ZS7).and(has(SignalHV.STOPSIGNAL)), 4.6f);
			// HP 0
			cm.register("hv/hv_hp", with(SignalHV.STOPSIGNAL, hpvr -> hpvr.equals(HPVR.HPVR0)), 5.4f, "lamp_red_primarynorth", "girsignals:blocks/lamp_red", "lamp_red_secondarynorth", "girsignals:blocks/lamp_red");
			// HP 1
			cm.register("hv/hv_hp", with(SignalHV.STOPSIGNAL, hpvr -> hpvr.equals(HPVR.HPVR1)), 5.4f, "lamp_greennorth", "girsignals:blocks/lamp_green");
			// HP 2
			cm.register("hv/hv_hp", with(SignalHV.STOPSIGNAL, hpvr -> hpvr.equals(HPVR.HPVR2)), 5.4f, "lamp_greennorth", "girsignals:blocks/lamp_green", "lamp_yellownorth", "girsignals:blocks/lamp_yellow");
			// HP off
			cm.register("hv/hv_hp", with(SignalHV.STOPSIGNAL, hpvr -> hpvr.equals(HPVR.OFF)), 5.4f);
			// HP Status light
			cm.register("hv/hv_hp", with(SignalHV.STOPSIGNAL, hpvr -> hpvr.equals(HPVR.OFF_STATUS_LIGHT)), 5.4f, "lamp_white_identifiernorth", "girsignals:blocks/lamp_white_small");
			// HP RS
			cm.register("hv/hv_hp", with(SignalHV.STOPSIGNAL, hpvr -> hpvr.equals(HPVR.HPVR0_RS)), 5.4f, "lamp_red_primarynorth", "girsignals:blocks/lamp_red", "lamp_white_sh_1north", "girsignals:blocks/lamp_white_small");
			// Zs2, Zs2v, Zs3, Zs3v
			for(ZS32 zs3 : ZS32.values()) {
				cm.register("hv/hv_zs3", with(SignalHV.ZS3, pZs3 -> pZs3.equals(zs3)).and(has(SignalHV.STOPSIGNAL)), 6.9f, "7", "girsignals:blocks/zs3/" + zs3.name());
				cm.register("hv/hv_zs3v", with(SignalHV.ZS3V, pZs3 -> pZs3.equals(zs3)), 3f, "7", "girsignals:blocks/zs3/" + zs3.getDistant());
			}
			// VR0
			cm.register("hv/hv_vr", with(SignalHV.DISTANTSIGNAL, hpvr -> hpvr.equals(HPVR.HPVR0)), 4, "lamp_yellow_1north", "girsignals:blocks/lamp_yellow", "lamp_yellow_2north", "girsignals:blocks/lamp_yellow");
			// VR1
			cm.register("hv/hv_vr", with(SignalHV.DISTANTSIGNAL, hpvr -> hpvr.equals(HPVR.HPVR1)), 4, "lamp_green_1north", "girsignals:blocks/lamp_green", "lamp_green_2north", "girsignals:blocks/lamp_green");
			// VR2
			cm.register("hv/hv_vr", with(SignalHV.DISTANTSIGNAL, hpvr -> hpvr.equals(HPVR.HPVR2)), 4, "lamp_green_1north", "girsignals:blocks/lamp_green", "lamp_yellow_2north", "girsignals:blocks/lamp_yellow");
			// VR off
			cm.register("hv/hv_vr", with(SignalHV.DISTANTSIGNAL, hpvr -> hpvr.equals(HPVR.OFF)), 4);
			// VR Status light
			cm.register("hv/hv_vr_statuslight", hasAndIs(SignalHV.VR_LIGHT).and(has(SignalHV.DISTANTSIGNAL)), 4, "lamp_white_identifiernorth", "girsignals:blocks/lamp_white_small");
			// VR Status light off
		...
		registeredModels.put("kssignal", cm -> {
			...
			for (MAST_SIGN sign : MAST_SIGN.values())
				if(!sign.equals(MAST_SIGN.OFF))
					cm.register("ks/ks_sign", with(SignalKS.MASTSIGN, ms -> ms.equals(sign)), 2, "13", "girsignals:blocks/" + sign.getName());
			
			cm.register("ks/ks_mast3", ebs -> true, 3);
			cm.register("ks/ks_mast4", ebs -> true, 4);
			// Zs2, Zs2v, Zs3, Zs3v
			for(ZS32 zs3 : ZS32.values()) {
				cm.register("ks/ks_zs3", with(SignalKS.ZS3, pZs3 -> pZs3.equals(zs3)), 6, "15", "girsignals:blocks/zs3/" + zs3.name());
				cm.register("ks/ks_zs3v", with(SignalKS.ZS3V, pZs3 -> pZs3.equals(zs3)), 4, "15", "girsignals:blocks/zs3/" + zs3.getDistant());
				cm.register("ks/ks_zs2", with(SignalKS.ZS2, pZs3 -> pZs3.equals(zs3)), 3, "15", "girsignals:blocks/zs3/" + zs3.getDistant());
			}
			// KS off
			cm.register("ks/ks_signal", with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.OFF)), 5);
			// HP 0
			cm.register("ks/ks_signal", with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.HP0)), 5, "lamp_rednorth", "girsignals:blocks/lamp_red");
			// KS 1
			cm.register("ks/ks_signal", with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS1)), 5, "lamp_greennorth", "girsignals:blocks/lamp_green");
			// KS 1 Light
			cm.register("ks/ks_signal", with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS1_LIGHT)), 5, "lamp_greennorth", "girsignals:blocks/lamp_green", "lamp_white_identifiernorth", "girsignals:blocks/lamp_white_small");
			// KS 1 Blink
			cm.register("ks/ks_signal", with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS1_BLINK)), 5, "lamp_greennorth", "girsignals:blocks/lamp_green_blink");
			// KS 1 Blink Light
			cm.register("ks/ks_signal", with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS1_BLINK_LIGHT)), 5, "lamp_greennorth", "girsignals:blocks/lamp_green_blink", "lamp_white_identifiernorth", "girsignals:blocks/lamp_white_small");
			// KS 2
			cm.register("ks/ks_signal", with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS2)), 5, "lamp_yellownorth", "girsignals:blocks/lamp_yellow");
			// KS 2 Light
			cm.register("ks/ks_signal", with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS2_LIGHT)), 5, "lamp_yellownorth", "girsignals:blocks/lamp_yellow", "lamp_white_identifiernorth", "girsignals:blocks/lamp_white_small");
			// KS Zs1
			cm.register("ks/ks_signal", with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS_ZS1)), 5, "lamp_rednorth", "girsignals:blocks/lamp_red", "lamp_white_sh_zsnorth", "girsignals:blocks/lamp_white_small_blink");
			// KS Zs7
			cm.register("ks/ks_signal", with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS_ZS7)), 5, "lamp_rednorth", "girsignals:blocks/lamp_red", "lamp_zs7north", "girsignals:blocks/lamp_yellow_small");
			// KS RS
			cm.register("ks/ks_signal", with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS_RS)), 5, "lamp_rednorth", "girsignals:blocks/lamp_red", "lamp_white_sh_zsnorth", "girsignals:blocks/lamp_white_small", "lamp_white_shnorth", "girsignals:blocks/lamp_white_small");
			// KS Status light
			cm.register("ks/ks_signal", with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.KS_STATUS_LIGHT)), 5, "lamp_white_identifiernorth", "girsignals:blocks/lamp_white_small");
			
			//KS off Distant
			cm.register("ks/ks_signal_dist", with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS.OFF)), 5);
			//KS 1 Distant 
			cm.register("ks/ks_signal_dist", with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS.KS1)), 5, "lamp_greennorth", "girsignals:blocks/lamp_green");
			// KS 1 Light Distant
			cm.register("ks/ks_signal_dist", with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS.KS1_LIGHT)), 5, "lamp_greennorth", "girsignals:blocks/lamp_green", "lamp_white_identifiernorth", "girsignals:blocks/lamp_white_small");
			// KS 1 Repeat Distant
			cm.register("ks/ks_signal_dist", with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS.KS1_REPEAT)), 5, "lamp_greennorth", "girsignals:blocks/lamp_green", "lamp_white_sh_zsnorth", "girsignals:blocks/lamp_white_small");
			// KS 1 Blink Distant
			cm.register("ks/ks_signal_dist", with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS.KS1_BLINK)), 5, "lamp_greennorth", "girsignals:blocks/lamp_green_blink");
			// KS 1 Blink Light Distant
			cm.register("ks/ks_signal_dist", with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS.KS1_BLINK_LIGHT)), 5, "lamp_greennorth", "girsignals:blocks/lamp_green_blink", "lamp_white_identifiernorth", "girsignals:blocks/lamp_white_small");
			// KS 1 Blink Repeat Distant
			cm.register("ks/ks_signal_dist", with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS.KS1_BLINK_REPEAT)), 5, "lamp_greennorth", "girsignals:blocks/lamp_green_blink", "lamp_white_sh_zsnorth", "girsignals:blocks/lamp_white_small");
			// KS 2 Distant
			cm.register("ks/ks_signal_dist", with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS.KS2)), 5, "lamp_yellownorth", "girsignals:blocks/lamp_yellow");
			// KS 2 Light Distant
			cm.register("ks/ks_signal_dist", with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS.KS2_LIGHT)), 5, "lamp_yellownorth", "girsignals:blocks/lamp_yellow", "lamp_white_identifiernorth", "girsignals:blocks/lamp_white_small");
			// KS 2 Repeat Distant
			cm.register("ks/ks_signal_dist", with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS.KS2_REPEAT)), 5, "lamp_yellownorth", "girsignals:blocks/lamp_yellow", "lamp_white_sh_zsnorth", "girsignals:blocks/lamp_white_small");
			// KS Status light Distant
			cm.register("ks/ks_signal_dist", with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS.KS_STATUS_LIGHT)), 5, "lamp_white_identifiernorth", "girsignals:blocks/lamp_white_small");
		});
		registeredModels.put("hlsignal", cm -> {
			...
			for (MAST_SIGN sign : MAST_SIGN.values())
				if(!sign.equals(MAST_SIGN.OFF))
					cm.register("hl/hl_sign_main", with(SignalHL.MASTSIGN, ms -> ms.equals(sign)), 2, "9", "girsignals:blocks/" + sign.getName());
			
			cm.register("hl/hl_mast3", ebs -> true, 3);
			for(ZS32 zs3 : ZS32.values()) {
				cm.register("hl/hl_zs2", with(SignalHL.ZS2, pZs3 -> pZs3.equals(zs3)), 3, "signalnorth", "girsignals:blocks/zs3/" + zs3.name());
			}
			cm.register("hl/hl_mast4", ebs -> true, 4);
			// HL Lightbar off
			cm.register("hl/hl_shield2", with(SignalHL.LIGHTBAR, hllb -> hllb.equals(HL_LIGHTBAR.OFF)), 4);
			// HL Lightbar green
			cm.register("hl/hl_shield2", with(SignalHL.LIGHTBAR, hllb -> hllb.equals(HL_LIGHTBAR.GREEN)), 4, "lamp_greennorth", "girsignals:blocks/lamp_green_small");
			// HL Lightbar yellow
			cm.register("hl/hl_shield2", with(SignalHL.LIGHTBAR, hllb -> hllb.equals(HL_LIGHTBAR.YELLOW)), 4, "lamp_yellownorth", "girsignals:blocks/lamp_yellow_small");
			// HL off
			cm.register("hl/hl_shield1", with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.OFF)), 5);
			// HL red
			cm.register("hl/hl_shield1", with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.HP0)), 5, "lamp_rednorth", "girsignals:blocks/lamp_red");
			// HL alternate red
			cm.register("hl/hl_shield1", with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.HP0_ALTERNATE_RED)), 5, "lamp_red2north", "girsignals:blocks/lamp_red");
			// HL 1
			cm.register("hl/hl_shield1", with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.HL1)), 5, "lamp_greennorth", "girsignals:blocks/lamp_green");
			// HL 2/3
			cm.register("hl/hl_shield1", with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.HL2_3)), 5, "lamp_greennorth", "girsignals:blocks/lamp_green", "lamp_yellow2north", "girsignals:blocks/lamp_yellow");
			// HL 4
			cm.register("hl/hl_shield1", with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.HL4)), 5, "lamp_greennorth", "girsignals:blocks/lamp_green_blink");
			// HL 5/6
			cm.register("hl/hl_shield1", with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.HL5_6)), 5, "lamp_greennorth", "girsignals:blocks/lamp_green_blink", "lamp_yellow2north", "girsignals:blocks/lamp_yellow");
			// HL 7
			cm.register("hl/hl_shield1", with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.HL7)), 5, "lamp_yellownorth", "girsignals:blocks/lamp_yellow_blink");
			// HL 8/9
			cm.register("hl/hl_shield1", with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.HL8_9)), 5, "lamp_yellownorth", "girsignals:blocks/lamp_yellow_blink", "lamp_yellow2north", "girsignals:blocks/lamp_yellow");
			// HL 10
			cm.register("hl/hl_shield1", with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.HL10)), 5, "lamp_yellownorth", "girsignals:blocks/lamp_yellow");
			// HL 11/12
			cm.register("hl/hl_shield1", with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.HL11_12)), 5, "lamp_yellownorth", "girsignals:blocks/lamp_yellow", "lamp_yellow2north", "girsignals:blocks/lamp_yellow");
			// HL Zs1
			cm.register("hl/hl_shield1", with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.HL_ZS1)), 5, "lamp_rednorth", "girsignals:blocks/lamp_red", "lamp_white_sh_2north", "girsignals:blocks/lamp_white_small_blink");
			// HL RS
			cm.register("hl/hl_shield1", with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.HL_RS)), 5, "lamp_rednorth", "girsignals:blocks/lamp_red", "lamp_white_sh_1north", "girsignals:blocks/lamp_white_small", "lamp_white_sh_2north", "girsignals:blocks/lamp_white_small");
			// HL Status light
			cm.register("hl/hl_shield1", with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.HL_STATUS_LIGHT)), 5,"lamp_white_sh_2north", "girsignals:blocks/lamp_white_small");
			
			// HL off Distant
			cm.register("hl/hl_shield_dist", with(SignalHL.DISTANTSIGNAL, hl -> hl.equals(HL.OFF)), 5);
			// HL 1
			cm.register("hl/hl_shield_dist", with(SignalHL.DISTANTSIGNAL, hl -> hl.equals(HL.HL1)), 5, "lamp_greennorth", "girsignals:blocks/lamp_green");
			// HL 4
			cm.register("hl/hl_shield_dist", with(SignalHL.DISTANTSIGNAL, hl -> hl.equals(HL.HL4)), 5, "lamp_greennorth", "girsignals:blocks/lamp_green_blink");
			// HL 7
			cm.register("hl/hl_shield_dist", with(SignalHL.DISTANTSIGNAL, hl -> hl.equals(HL.HL7)), 5, "lamp_yellownorth", "girsignals:blocks/lamp_yellow_blink");
			// HL 10
			cm.register("hl/hl_shield_dist", with(SignalHL.DISTANTSIGNAL, hl -> hl.equals(HL.HL10)), 5, "lamp_yellownorth", "girsignals:blocks/lamp_yellow");
			// HL Status light
			cm.register("hl/hl_shield_dist", with(SignalHL.DISTANTSIGNAL, hl -> hl.equals(HL.HL_STATUS_LIGHT)), 5,"lamp_white_sh_2north", "girsignals:blocks/lamp_white_small");
		});
		registeredModels.put("shlight", cm -> {
			// SH ground off
			cm.register("sh/sh_light", with(SignalSHLight.SHLIGHT_0, sh -> sh.equals(SH_LIGHT.OFF)).and(has(SignalSHLight.SHLIGHT_2).negate()), 0);
			// SH ground sh0
			cm.register("sh/sh_light", with(SignalSHLight.SHLIGHT_0, sh -> sh.equals(SH_LIGHT.SH0)).and(has(SignalSHLight.SHLIGHT_2).negate()), 0, "lamp_rednorth", "girsignals:blocks/lamp_red_small");
			// SH ground sh1
			cm.register("sh/sh_light", with(SignalSHLight.SHLIGHT_0, sh -> sh.equals(SH_LIGHT.SH1)).and(has(SignalSHLight.SHLIGHT_2).negate()), 0, "lamp_whitenorth", "girsignals:blocks/lamp_white_small");
			// Mast
			...
			// SH above off
			cm.register("sh/sh_light", with(SignalSHLight.SHLIGHT_2, sh -> sh.equals(SH_LIGHT.OFF)).and(has(SignalSHLight.SHLIGHT_0).negate()), 2);
			// SH above sh0
			cm.register("sh/sh_light", with(SignalSHLight.SHLIGHT_2, sh -> sh.equals(SH_LIGHT.SH0)).and(has(SignalSHLight.SHLIGHT_0).negate()), 2, "lamp_rednorth", "girsignals:blocks/lamp_red_small");
			// SH above sh1
			cm.register("sh/sh_light", with(SignalSHLight.SHLIGHT_2, sh -> sh.equals(SH_LIGHT.SH1)).and(has(SignalSHLight.SHLIGHT_0).negate()), 2, "lamp_whitenorth", "girsignals:blocks/lamp_white_small");
		});
		...
		registeredModels.put("lfsignal", cm -> {
			...
			for(LF lf1 : LF.values()) {
				...
				cm.register("lf/lf3_5_7", withN(SignalLF.LFTYPE, LFBACKGROUND.LF3::equals).and(withN(SignalLF.INDICATOR, lf1::equals)), 1, rename);
