	...
	public void onResourceManagerReload(IResourceManager resourceManager) {
		...
		registeredModels.put("hvsignal", cm -> {
			...
			cm.register("hv/hv_exit",
					with(SignalHV.STOPSIGNAL, hpvr -> hpvr.equals(HP.HP0)).and(
							withN(SignalHV.HPTYPE, hpt -> hpt.equals(HP_TYPE.STOPSIGNAL)).or(hasNot(SignalHV.HPTYPE))),
					5.4f, "lamp_red_primarynorth", "girsignals:blocks/lamps/lamp_red", "lamp_red_secondarynorth",
					"girsignals:blocks/lamps/lamp_red");
			// HP 1
			cm.register("hv/hv_exit",
					with(SignalHV.STOPSIGNAL, hpvr -> hpvr.equals(HP.HP1)).and(
							withN(SignalHV.HPTYPE, hpt -> hpt.equals(HP_TYPE.STOPSIGNAL)).or(hasNot(SignalHV.HPTYPE))),
					5.4f, "lamp_greennorth", "girsignals:blocks/lamps/lamp_green");
			// HP 2
			cm.register("hv/hv_exit",
					with(SignalHV.STOPSIGNAL, hpvr -> hpvr.equals(HP.HP2)).and(
							withN(SignalHV.HPTYPE, hpt -> hpt.equals(HP_TYPE.STOPSIGNAL)).or(hasNot(SignalHV.HPTYPE))),
					5.4f, "lamp_greennorth", "girsignals:blocks/lamps/lamp_green", "lamp_yellownorth",
					"girsignals:blocks/lamps/lamp_yellow");
			// HP off
			cm.register("hv/hv_exit",
					with(SignalHV.STOPSIGNAL, hpvr -> hpvr.equals(HP.OFF)).and(
							withN(SignalHV.HPTYPE, hpt -> hpt.equals(HP_TYPE.STOPSIGNAL)).or(hasNot(SignalHV.HPTYPE))),
					5.4f);
			// HP RS
			cm.register("hv/hv_exit",
					with(SignalHV.STOPSIGNAL, hpvr -> hpvr.equals(HP.SHUNTING)).and(
							withN(SignalHV.HPTYPE, hpt -> hpt.equals(HP_TYPE.STOPSIGNAL)).or(hasNot(SignalHV.HPTYPE))),
					5.4f, "lamp_red_primarynorth", "girsignals:blocks/lamps/lamp_red", "lamp_white_sh_1north",
			...
			// HP Status light
			cm.register("hv/hv_identifier", hasAndIs(SignalHV.IDENTIFIER), 5.4f, "lamp_white_identifiernorth",
		...
		registeredModels.put("kssignal", cm -> {
			...
			cm.register("ks/ks_signal",
					with(SignalKS.STOPSIGNAL, ks -> ks.equals(KS.OFF)).and(
							withN(SignalKS.KSTYPE, kst -> kst.equals(KS_TYPE.STOPSIGNAL)).or(hasNot(SignalKS.KSTYPE))),
					5);
			// HP 0
			cm.register("ks/ks_signal",
			...
			// KS off Distant
			cm.register("ks/ks_signal_dist", with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS_DISTANT.OFF))
					.and(withN(SignalKS.KSTYPE, kst -> kst.equals(KS_TYPE.DISTANT))), 5);
			// KS 1 Distant
			cm.register("ks/ks_signal_dist",
					with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS_DISTANT.KS1)).and(
							withN(SignalKS.KSTYPE, kst -> kst.equals(KS_TYPE.DISTANT)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_greennorth", "girsignals:blocks/lamps/lamp_green");
			// KS 1 Repeat Distant
			cm.register("ks/ks_signal_dist",
					with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS_DISTANT.KS1_REPEAT)).and(
							withN(SignalKS.KSTYPE, kst -> kst.equals(KS_TYPE.DISTANT)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_greennorth", "girsignals:blocks/lamps/lamp_green", "lamp_white_sh_zsnorth",
					"girsignals:blocks/lamps/lamp_white");
			// KS 1 Blink Distant
			cm.register("ks/ks_signal_dist",
					with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS_DISTANT.KS1_BLINK)).and(
							withN(SignalKS.KSTYPE, kst -> kst.equals(KS_TYPE.DISTANT)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_greennorth", "girsignals:blocks/lamps/lamp_green_blink");
			// KS 1 Blink Light Distant
			cm.register("ks/ks_signal_dist",
					with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS_DISTANT.KS1_BLINK_LIGHT)).and(
							withN(SignalKS.KSTYPE, kst -> kst.equals(KS_TYPE.DISTANT)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_greennorth", "girsignals:blocks/lamps/lamp_green_blink", "lamp_white_identifiernorth",
					"girsignals:blocks/lamps/lamp_white");
			// KS 1 Blink Repeat Distant
			cm.register("ks/ks_signal_dist",
					with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS_DISTANT.KS1_BLINK_REPEAT)).and(
							withN(SignalKS.KSTYPE, kst -> kst.equals(KS_TYPE.DISTANT)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_greennorth", "girsignals:blocks/lamps/lamp_green_blink", "lamp_white_sh_zsnorth",
					"girsignals:blocks/lamps/lamp_white");
			// KS 2 Distant
			cm.register("ks/ks_signal_dist",
					with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS_DISTANT.KS2)).and(
							withN(SignalKS.KSTYPE, kst -> kst.equals(KS_TYPE.DISTANT)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_yellownorth", "girsignals:blocks/lamps/lamp_yellow");
			// KS 2 Light Distant
			cm.register("ks/ks_signal_dist",
					with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS_DISTANT.KS2_LIGHT)).and(
							withN(SignalKS.KSTYPE, kst -> kst.equals(KS_TYPE.DISTANT)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_yellownorth", "girsignals:blocks/lamps/lamp_yellow", "lamp_white_identifiernorth",
					"girsignals:blocks/lamps/lamp_white");
			// KS 2 Repeat Distant
			cm.register("ks/ks_signal_dist",
					with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS_DISTANT.KS2_REPEAT)).and(
							withN(SignalKS.KSTYPE, kst -> kst.equals(KS_TYPE.DISTANT)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_yellownorth", "girsignals:blocks/lamps/lamp_yellow", "lamp_white_sh_zsnorth",
					"girsignals:blocks/lamps/lamp_white");
			// KS Status light Distant
			cm.register("ks/ks_signal_dist",
					with(SignalKS.DISTANTSIGNAL, ks -> ks.equals(KS_DISTANT.KS_STATUS_LIGHT)).and(
							withN(SignalKS.KSTYPE, kst -> kst.equals(KS_TYPE.DISTANT)).or(hasNot(SignalKS.KSTYPE))),
					5, "lamp_white_identifiernorth", "girsignals:blocks/lamps/lamp_white");
		});
		registeredModels.put("hlsignal", cm -> {
			...
			cm.register("hl/hl_shield1", with(SignalHL.STOPSIGNAL, hl -> hl.equals(HL.OFF))
					.and(withN(SignalHL.HLTYPE, hlt -> hlt.equals(HL_TYPE.MAIN)).or(hasNot(SignalHL.HLTYPE))), 5);
			// HL red
			...
			// HL off Distant
			cm.register("hl/hl_shield_dist", with(SignalHL.DISTANTSIGNAL, hl -> hl.equals(HL_DISTANT.OFF))
					.and(withN(SignalHL.HLTYPE, hlt -> hlt.equals(HL_TYPE.DISTANT)).or(hasNot(SignalHL.HLTYPE))), 5);
			// HL 1 Distant
			cm.register("hl/hl_shield_dist",
					with(SignalHL.DISTANTSIGNAL, hl -> hl.equals(HL_DISTANT.HL1)).and(
							withN(SignalHL.HLTYPE, hlt -> hlt.equals(HL_TYPE.DISTANT)).or(hasNot(SignalHL.HLTYPE))),
					5, "lamp_greennorth", "girsignals:blocks/lamps/lamp_green");
			// HL 4 Distant
			cm.register("hl/hl_shield_dist",
					with(SignalHL.DISTANTSIGNAL, hl -> hl.equals(HL_DISTANT.HL4)).and(
							withN(SignalHL.HLTYPE, hlt -> hlt.equals(HL_TYPE.DISTANT)).or(hasNot(SignalHL.HLTYPE))),
					5, "lamp_greennorth", "girsignals:blocks/lamps/lamp_green_blink");
			// HL 7 Distant
			cm.register("hl/hl_shield_dist",
					with(SignalHL.DISTANTSIGNAL, hl -> hl.equals(HL_DISTANT.HL7)).and(
							withN(SignalHL.HLTYPE, hlt -> hlt.equals(HL_TYPE.DISTANT)).or(hasNot(SignalHL.HLTYPE))),
					5, "lamp_yellownorth", "girsignals:blocks/lamps/lamp_yellow_blink");
			// HL 10 Distant
			cm.register("hl/hl_shield_dist",
					with(SignalHL.DISTANTSIGNAL, hl -> hl.equals(HL_DISTANT.HL10)).and(
							withN(SignalHL.HLTYPE, hlt -> hlt.equals(HL_TYPE.DISTANT)).or(hasNot(SignalHL.HLTYPE))),
					5, "lamp_yellownorth", "girsignals:blocks/lamps/lamp_yellow");
			// HL Status light Distant
			cm.register("hl/hl_shield_dist",
					with(SignalHL.DISTANTSIGNAL, hl -> hl.equals(HL_DISTANT.HL_STATUS_LIGHT)).and(
							withN(SignalHL.HLTYPE, hlt -> hlt.equals(HL_TYPE.DISTANT)).or(hasNot(SignalHL.HLTYPE))),
					5, "lamp_white_sh_2north", "girsignals:blocks/lamps/lamp_white");
		});
		registeredModels.put("shlight", cm -> {
			...
			cm.register("sh/sh_light",
					with(SignalSHLight.SHLIGHT_0, sh -> sh.equals(SH_LIGHT.STATUS_LIGHT))
							.and(hasAndIsNot(SignalSHLight.SH_HIGH)),
		...
		registeredModels.put("rasignal", cm -> {
			...
			cm.register("ra/ra11_sh1",
					hasAndIsNot(SignalRA.RALIGHT).and(withN(SignalRA.RATYPE, ra -> ra.equals(RA.RA11A)).or(withN(SignalRA.RATYPE, ra -> ra.equals(RA.RA11B)))), 3);
			cm.register("ra/ra11_sh1",
					hasAndIs(SignalRA.RALIGHT).and(withN(SignalRA.RATYPE, ra -> ra.equals(RA.RA11A)).or(withN(SignalRA.RATYPE, ra -> ra.equals(RA.RA11B)))), 3, "3",
					"girsignals:blocks/lamps/lamp_white");
