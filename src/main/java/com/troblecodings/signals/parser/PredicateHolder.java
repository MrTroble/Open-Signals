...
public final class PredicateHolder {
	...
	public static Predicate<Map<SEProperty, Object>> check(final SEProperty property, final Object type) {
		return check(property, type::equals);
	}

	public static Predicate<Map<SEProperty, Object>> check(final SEProperty property, final Predicate type) {
		return t -> {
