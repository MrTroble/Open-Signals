...
public class SEProperty extends ModelProperty<String> implements IIntegerable<String> {
	...
	public SEProperty(final String name, final JsonEnum parent, final String defaultValue, final ChangeableStage stage,
			final Predicate<Map<SEProperty, String>> deps, final int itemDamage) {
		this.name = name;
		this.parent = parent;
	...
	public boolean equals(final Object obj) {
		...
		return Objects.equals(allowedValues, other.allowedValues) && Objects.equals(defaultValue, other.defaultValue)
	...
	public static class SEAutoNameProp extends SEProperty {
		...
		public SEAutoNameProp(final String name, final JsonEnum parent, final String defaultValue,
				final ChangeableStage stage, final Predicate<Map<SEProperty, String>> deps, final int itemDamage) {
