...
public class SidePanel {
    ...
    public SidePanel(final UIEntity lowerEntity, final GuiSignalBox gui) {
        ...
        label.add(rotate);
        final UILabel labelComponent = new UILabel(I18n.format("info.infolabel"));
    ...
    public void addHelpPageToPlane() {
        if (showHelpPage) {
            helpPageButton.setText(I18n.format("info.info") + "  >");
    ...
    public void updateNextNode(final int selection, final int rotation) {
        ...
        infoEntity.add(GuiElements.createLabel(I18n.format("info.nextelement"),
        ...
        infoEntity.add(GuiElements.createLabel("[R] = " + I18n.format("info.editor.key.r"),
                new UIEntity().getInfoTextColor(), 0.5f));
        infoEntity.add(GuiElements.createLabel("[LMB] = " + I18n.format("info.editor.key.lmb"),
                new UIEntity().getInfoTextColor(), 0.5f));
        infoEntity.add(GuiElements.createLabel("[RMB] = " + I18n.format("info.editor.key.rmb"),
                new UIEntity().getInfoTextColor(), 0.5f));
        infoEntity.add(GuiElements.createSpacerV(5));
        infoEntity.add(GuiElements.createLabel(I18n.format("info.description"),
                new UIEntity().getBasicTextColor(), 0.8f));
        infoEntity
                .add(GuiElements.createLabel(I18n.format("info." + modes.toString().toLowerCase()),
                        new UIEntity().getInfoTextColor(), 0.5f));
        addHelpPageToPlane();
    }
    ...
    public void helpUsageMode(final Map<BlockPos, SubsidiaryHolder> subsidiaries,
        ...
        helpList.add(GuiElements.createLabel(I18n.format("info.keys"),
                new UIEntity().getBasicTextColor(), 0.8f));
        helpList.add(GuiElements.createLabel("[LMB] = " + I18n.format("info.usage.key.lmb"),
                new UIEntity().getInfoTextColor(), 0.5f));
        helpList.add(GuiElements.createLabel("[RMB] = " + I18n.format("info.usage.key.rmb"),
                new UIEntity().getInfoTextColor(), 0.5f));

        final Minecraft mc = Minecraft.getMinecraft();
        if (!allNodes.isEmpty()) {
            final UIEntity manuelButton = GuiElements.createButton(I18n.format("info.usage.manuel"),
                    e -> {
                            ...
                            allNodes.forEach(currentNode -> {
                                ...
                                currentNode.getModes().forEach((mode, entry) -> {
                                    ...
                                    final UIEntity button = GuiElements.createButton(name, e1 -> {
                                        ...
                                        textureEntity.add(
                                                new UIToolTip(I18n.format("info.usage.rs.desc")));
            ...
            manuelButton.add(new UIToolTip(I18n.format("info.usage.manuel.desc")));
        }
        ...
        if (node != null) {
            ...
            helpList.add(GuiElements.createLabel(I18n.format("info.usage.node"),
                    new UIEntity().getBasicTextColor(), 0.8f));
            final UIEntity reset = GuiElements.createButton(I18n.format("button.reset"),
                    e -> gui.resetPathwayOnServer(node));
            reset.setScaleX(0.8f);
            reset.setScaleY(0.8f);
            reset.setX(5);
            helpList.add(reset);
            reset.add(new UIToolTip(I18n.format("button.reset.desc")));
            ...
            for (final Map.Entry<ModeSet, PathOptionEntry> mapEntry : modes.entrySet()) {
                ...
                if (option.containsEntry(PathEntryType.SIGNAL)) {
                    ...
                    helpList.add(GuiElements.createLabel(
                            ...
                            new UIEntity().getBasicTextColor(), 0.8f));
                    final UIEntity entity = GuiElements.createButton(I18n.format("btn.subsidiary"),
                            e -> {
                                final UIBox hbox = new UIBox(UIBox.VBOX, 1);
                                final UIEntity list = new UIEntity();
                                list.setInherits(true);
                                list.add(hbox);
                                list.add(GuiElements.createButton(I18n.format("btn.return"),
                                        a -> gui.pop()));
                    ...
                    entity.setX(5);
                    helpList.add(entity);
                    entity.add(new UIToolTip(I18n.format("btn.subsidiary.desc")));
                }
            }
            final UIEntity edit = GuiElements.createButton(I18n.format("info.usage.edit"), e -> {
            ...
            edit.setX(5);
            helpList.add(edit);
            edit.add(new UIToolTip(I18n.format("info.usage.edit.desc")));
        }
            ...
            subsidiaries.forEach((pos, holder) -> {
                ...
                final UIEntity button = GuiElements.createButton(name, e -> {
                    final UIEntity screen = GuiElements.createScreen(selectionEntity -> {
                        ...
                        final UILabel info = new UILabel(I18n.format("sb.disablesubsidiary"));
                        ...
                        final UIEntity buttonYes = GuiElements.createButton(I18n.format("btn.yes"),
                                e1 -> {
                                    gui.pop();
                                    disableSubsidiary.accept(pos, holder);
                                });
                        final UIEntity buttonNo = GuiElements.createButton(I18n.format("btn.no"),
                                e2 -> gui.pop());
