...
public class SignalBoxPathway implements IChunkLoadable {
    ...
    public void read(final NBTWrapper tag) {
        final ImmutableList.Builder<SignalBoxNode> nodeBuilder = ImmutableList
                .builder();
        ...
        if (!blockWrapper.isTagNull()) {
            ...
            if (world == null || world.isClientSide) {
                ...
                if (otherGrid.get() == null)
                    loadChunkAndGetTile(SignalBoxTileEntity.class, (ServerWorld) world, otherPos,
    ...
    public void linkPathways() {
        ...
        if (blockPW != null) {
            ...
            if (otherGrid.get() == null)
                loadChunkAndGetTile(SignalBoxTileEntity.class, (ServerWorld) world,
    ...
    public void updatePathwaySignals() {
        ...
        if (delay > 0) {
            ...
            if (pathwayToBlock != null) {
                loadChunkAndGetTile(SignalBoxTileEntity.class, (ServerWorld) pathwayToBlock.world,
            ...
            service.execute(() -> {
                ...
                world.getServer().execute(() -> {
                    loadChunkAndGetTile(SignalBoxTileEntity.class, (ServerWorld) world, tilePos,
                            (thisTile, _u1) -> {
                    ...
                    if (pathwayToBlock != null) {
                        loadChunkAndGetTile(SignalBoxTileEntity.class,
                                (ServerWorld) pathwayToBlock.world, pathwayToBlock.tilePos,
                                (otherTile, _u1) -> {
    ...
    public void resetPathway(final @Nullable Point point) {
        ...
        if (point == null || point.equals(this.getLastPoint())
            ...
            resetOther();
            if (pathwayToReset != null) {
                loadChunkAndGetTile(SignalBoxTileEntity.class, (ServerWorld) pathwayToReset.world,
